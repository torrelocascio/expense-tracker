...
export class CustomerService{
  ...
  addCustomer(customer: Customer){
   ...
   return this.http.post('https://git.heroku.com/expense-tracker-torrelocascio.git/customers',body, {headers: headers})
          .map((response: any) => {
  ...
  getCustomers(){
    return this.http.get('https://git.heroku.com/expense-tracker-torrelocascio.git/customers')
...
updateCustomer(customer:Customer){
  const body = JSON.stringify(customer)
  const headers = new Headers({'Content-Type': 'application/json'})
 return this.http.patch('https://git.heroku.com/expense-tracker-torrelocascio.git/customers/'+ customer.id , body , {headers: headers})
...
deleteCustomer(customer: Customer){
  ...
  return this.http.delete('https://git.heroku.com/expense-tracker-torrelocascio.git/customers'+ customer.id)
  .map((response: Response) => response.json())
  // .catch((error: Response) => {
  //   this.errorService.handleError(error.json())
  //  return Observable.throw(error.json())
