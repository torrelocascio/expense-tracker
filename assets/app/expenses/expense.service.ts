...
export class ExpenseService{
  ...
  addExpense(expense: Expense, project: Project){
   ...
   return this.http.post('https://expense-tracker-torrelocascio.herokuapp.com/expense/' + expense.project.id,body, {headers: headers})
          .map((response: any) => {
  ...
  getExpenses(){
    return this.http.get('https://expense-tracker-torrelocascio.herokuapp.com/expense')
      .map((response:any)=> {
...
updateExpense(expense:Expense){
  const body = JSON.stringify(expense)
  const headers = new Headers({'Content-Type': 'application/json'})
 return this.http.patch('https://expense-tracker-torrelocascio.herokuapp.com/expense/'+ expense.id , body , {headers: headers})
