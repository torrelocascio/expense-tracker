...
export class ProjectService{
  ...
  addProject(project: Project, customer: Customer){
   ...
   return this.http.post('https://expense-tracker-torrelocascio.herokuapp.com/project/' + customer.id,body, {headers: headers})
          .map((response: any) => {
  ...
  getProjects(){
    return this.http.get('https://expense-tracker-torrelocascio.herokuapp.com/project')
...
updateProject(project:Project){
  const body = JSON.stringify(project)
  const headers = new Headers({'Content-Type': 'application/json'})
 return this.http.patch('https://expense-tracker-torrelocascio.herokuapp.com/project/'+ project.id , body , {headers: headers})
...
deleteProject(project: Project){
  ...
  console.log(project)
  return this.http.delete('https://expense-tracker-torrelocascio.herokuapp.com/project/'+ project.id)
  .map((response: Response) => response.json())
//   .catch((error: Response) => {
//     this.errorService.handleError(error.json())
//    return Observable.throw(error.json())
